...
void Dibujar()
{
    ...
    glPushMatrix();
        // se traslada a la posición concreta en el mundo
...
{
    // según sea la tecla oprimida se incrementa una u otra variable de movimiento
    switch (key)
    {
        case 'o':
                xpos--;
...
int main(int argc, char **argv)
{
    ...
    glutInit(&argc, argv); // definición típica de una ventana
    ...
    glutIdleFunc(Dibujar); // cuando no este haciendo nada también dibujará
